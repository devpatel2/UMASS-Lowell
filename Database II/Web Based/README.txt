...
The form currently runs on localhost using XAMPP with apache and MySQL features on. phpMyAdmin is used to manage the database. The files are separated into HTML and php in this folder, but all files should be in one folder when run.
