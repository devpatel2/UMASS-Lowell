This program demonstrates a producer-consumer network. The producer makes donuts and consumers eat them by the dozens. Mutex and conditions are used to lock consumers.
